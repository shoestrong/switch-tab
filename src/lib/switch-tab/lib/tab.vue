<template>
    <div
        class="tabbar b b-b"
        :class="{'tabbar-fix-bottom': fixBottom}"
        ref="viewArea"
    >
        <div
            class="tab-list"
...
export default {
    ...
    methods: {
        ...
        calcBarPosX() {
            ...
            this.activeBarWidth = Math.max(itemWidth * 0.6, 14); //动态计算宽度
            // this.activeBarX = itemLeft + (itemWidth - this.activeBarWidth) / 2;
            this.activeBarX = itemLeft + (itemWidth - 20) / 2;
        },
...
.tabbar.tabbar-fix-bottom .tab-item {
